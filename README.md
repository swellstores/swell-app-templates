...
The managed templates are under development. Released Swell CLI integration and end-to-end deployment verification are pending; they are not yet a supported managed-hosting quickstart. Their READMEs describe local evaluation and the intended Swell deployment workflow.
